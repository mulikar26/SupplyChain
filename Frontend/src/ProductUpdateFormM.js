...
<nav class="navbar navbar-expand-lg navbar-dark  bg-primary">
 ...
 <Link to="/Manufacturer/manufacturer/product"  ><button class="btn btn-primary me-md-2 ">Product List</button></Link>
 </form>
 </div>
 </>;
};
export default ProductUpdateFormM;