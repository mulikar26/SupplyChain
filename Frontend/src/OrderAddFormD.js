 ...
 <option >--select--</option>
{
 ...
 <Button type="submit" >Add</Button> <Link to="/distributer" ><button class="btn btn-primary my-3 "> Home</button></Link>
 </form>
